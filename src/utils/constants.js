...
// import CidLogo from '../components/imgs/cidlogo.png'
...
export const logo = 'https://drive.google.com/file/d/1AsSI6bYRzBKHKOOHbWJO94kJI-DkgJvW/view?usp=sharing';

export const categories = [
  // { name: 'New', icon: <HomeIcon />, },
  { name: 'Trending', icon: <TrendingUpOutlinedIcon />, },
  ...
  { name: 'CID', icon: <LocalPoliceOutlinedIcon />, },
  { name: 'Bhajan', icon: <PlayCircleIcon />, },
